...
const Assignticket = () => {
    ...
    const form = Ticktelist.filter(ticket => ticket.actions === "assign");
    ...
    return (
        ...
        <div class="container table-container">
            ...
            <ul class="nav nav-pills mb-3">
                ...
                <li class="nav-item"><a class="nav-link active" href="/assign">Open Tickets</a></li>
                ...
                <tbody>
                    {
                        form.map((ticket, index) => (
                            ...
                            <tr key={ticket._id}>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button className='btn btn-primary'>{ticket.actions}</button>
                                    </div>
                                </td>
