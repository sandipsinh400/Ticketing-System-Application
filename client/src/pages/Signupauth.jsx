  ...
  return (
    <>
      <div class="container h-50 w-50 mt-5">
        ...
        <form action="" class="form" method='post' onSubmit={handleSubmit(signup)}>
          <input required class="input" type="text" name="q_username" {...register('q_username')} id="username" placeholder="Username" />

          <input required class="input" type="email" name="q_email"  {...register('q_email')} id="email" placeholder="E-mail" />
